...
music_vae_checkpoint_dir = 'C:/Users/Li/PycharmProjects/AI_proj/hierdec-mel_16bar'
...
def generateMidi(word_string,
    ...
    print(word_vec)
    # model output
    latent_vec = wordvec_to_latentvec_model.predict(word_vec)
...
def main():
    ...
    path1 = 'C:/Users/Li/PycharmProjects/AI_proj/AI-proj/midids/BackToDecember.mid'
    path2 = 'C:/Users/Li/PycharmProjects/AI_proj/AI-proj/midids/test1.mid'
    p = []
    latent_train = []
    p.append(path1)
    p.append(path2)
    ...
    file = open('1.txt', 'w+')
    file.write(str(music_vae_model))
